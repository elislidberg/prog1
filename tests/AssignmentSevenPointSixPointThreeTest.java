...
// 		assertDogsAre("Metoden för att hitta den minsta hunden ska inte förändra listan", ORIGINAL_ORDER_OF_PREPARED_DOGS);
// 	}
// 
// 	public void indexOfSmallestDogCorrectlyIdentified(int start, int expected) {
// 		int actual = (Integer) callMethodUnderTest(sut, start);
// 		assertEquals(expected, actual, "Fel hund-index identifierat");
// 	}
// 
// 	@Test
